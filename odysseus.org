...
#+BEGIN_SRC emacs-lisp
  ...
  ;; (global-auto-revert-mode 1) ; too heavy atm
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (org-tag-alist '((:startgroup)
                     ...
                     (:endgroup)
                     ("translation" . ?t)))
    (org-capture-templates '(("t" "Task" entry (file+headline "~/.orpheus/org/refile.org" "Task")
                              (file "~/.emacs.d/local/org/task-template.org") :clock-in t :clock-resume t)
                             ("m" "Meeting" entry (file+headline "~/.orpheus/org/refile.org" "Meeting")
                              (file "~/.emacs.d/local/org/task-template.org") :clock-in t :clock-resume t)
                             ("j" "Journal" entry (file+headline "~/.orpheus/org/refile.org" "Journal")
                              (file "~/.emacs.d/local/org/task-template.org") :clock-in t :clock-resume t)))
    (org-agenda-files '("~/.orpheus/org/"
                        "~/.orpheus/org-roam/"))
    :hook
    (org-mode . (lambda ()
                  (visual-line-mode 1)
