...
#+BEGIN_SRC emacs-lisp
  ...
  ;;   (ivy-count-format "%d/%d")) ; deprecated in favor of helm

  ;; (use-package vertico
  ;;   :ensure t
  ;;   :init
  ;;   (vertico-mode 1)) ; deprecated in favor of helm
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (org-tag-alist '((:startgroup)
                     ...
                     ("translation" . ?t)
                     ("music" . ?m)))
    (org-capture-templates '(("t" "Task" entry (file+headline "~/.orpheus/org-agenda/refile.org" "Tasks")
                             ...
                             ("m" "Meeting" entry (file+headline "~/.orpheus/org-agenda/refile.org" "Meetings")
                              (file "~/.emacs.d/local/org/task-template.org") :clock-in t :clock-resume t)
                             ("j" "Journal" entry (file+headline "~/.orpheus/org-agenda/refile.org" "Journal")
                              (file "~/.emacs.d/local/org/task-template.org") :clock-in t :clock-resume t)))
